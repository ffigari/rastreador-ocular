...
%  - experimentación; cantidad ensayos
...
Para la primera ronda se diseñó un experimento de aproximádamente 10 minutos
durante el cual se presentó únicamente la tarea de antisacadas.
...
las cajas para que no entre en juego la memoria espacial?
cruces vs círculos para distinguir el tipo de tarea

\begin{figure}
    \centering
    \frame{\includegraphics[width=0.8\linewidth]{media/antisaccades-protocol.png}}

    se buscó reducir el impacto de procesos cognitivos? memoria espacial con las
    cajas

    cruces o círculos para distinguir la tarea para pro y anti
...
%  - calibración (+ validación + detección de descalibración)
al detectar descalibarción, calibro apenas termina el próximo ensayo?
o espero hasta el final del bloque?
...
# TODO:
#       . En metodos.tex no comentar sobre los resultados o sobre el por qué 
...
#       . Dsp en resultados.tex comentar sobre el impacto que la primer ronda
#       de experimentación tuvo en la segunda
