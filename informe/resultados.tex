...
una baja frecuencia de muestreo (figura \ref{{fig:sampling-frequency-by-age}}).
...
\begin{{figure}}
  ...
  \includegraphics[width=\linewidth]{{results/first-sampling-frequencies-by-age.png}}

  \includegraphics[width=\linewidth]{{results/second-sampling-frequencies-by-age.png}}
