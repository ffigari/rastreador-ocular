...
La tabla \ref{{tab:processing-results}} muestra las cantidades de ensayos
obtenidos y su considerable reducción luego de aplicar los criterios de
filtrado.

TODO: Hacer \ref a las tablas y figuras que describen un poco todo
...
\begin{{table}}[h]
  ...
  \begin{{tabular}}{{ c c | c c }}
    ...
    \multirow{{2}}{{10em}}{{proporción conservada}}
      & sujetos
      & {first__kept_subjects_proportion}
      & {second__kept_subjects_proportion} \\  
      & ensayos
      & {first__kept_trials_proportion}
      & {second__kept_trials_proportion} \\  
  \end{{tabular}}

  \caption{{Ensayos pre y post limpieza}}
  \label{{tab:processing-results}}
\end{{table}}

TODO: Tabla de correctitud
