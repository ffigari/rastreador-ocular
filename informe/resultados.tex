...
% TODO: Translate this to `first__ages_distribution_figure`
\begin{{figure}}
  \centering
  \includegraphics[width=0.4\linewidth]{{{first__ages_distribution_figure__logical_path}}}
  \caption{{{first__ages_distribution_figure__title}}}
  {first__ages_distribution_figure__comment}
