...
En un {second__antisaccades_correction_percentage}$\%$ de las antisacadas incorrectos se
realizó una corrección.

% TODO: Corregir acá que estoy diciendo que cuánto tomo en promedio pero en
%       verdad se está calculando el instante promedio de respuesta (y no la
%       diferencia promedio con la primer respuesta que es lo que si quiero)
Tal corrección tomó en promedio {second__corrected_antisaccades_sample__mean_correction_time}
ms (stdev {second__corrected_antisaccades_sample__mean_correction_time} ms).
