...
\begin{{itemize}}
  ...
  \item \begin{{enumerate}}
    \item \textbf{{autores}}:
      Huang et al, PACE \cite{{huang_2016_pace}} (\eyetracking auto
      calibrante).
    \item \textbf{{hardware necesario}}:
      Webcam.
    \item \textbf{{compatible con navegador}}:
  ...
  \item \begin{{enumerate}}
    \item \textbf{{autores}}:
      Xu et al, TurkerGaze \cite{{xu_2015_turker_gaze}} (generación de mapas de
  ...
  \item \begin{{enumerate}}
    \item \textbf{{autores}}:
      Papoutsaki et al, WebGazer \cite{{papoutsaki_2016_webgazer}}
...
(i.e., sus resultados para mismos individuos son consistentes a lo largo de
distintas instancias de análisis clínicos)
\cite{{plomecka_2020_retest_reliability}}. 

A continuación se resume el diseño y uso que distintos trabajos dan a la tarea
de antisacadas:
\begin{{itemize}}
  ...
  \item \begin{{enumerate}}
    \item \textbf{{autores}}:
      Unsworth et al \cite{{unsworth_2011_distribution_analysis}}, buscan
  ...
  \item \begin{{enumerate}}
    \item \textbf{{autores}}:
      Smyrnis et al \cite{{smyrnis_2002_big_sample}}, estudio sobre más de 2000
  ...
  \item \begin{{enumerate}}
    \item \textbf{{autores}}:
      P{{\l}}omecka et al \cite{{plomecka_2020_retest_reliability}}, estudio
